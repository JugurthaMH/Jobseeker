        ...
        <div class="box form-box">
            ...
            <form action="api.php" method="POST">
                <div class="field input">
                    <label id="nom" for="nom"></label>
                    <input type="text" name="nom" id="nom" required>
                </div>
                <div class="field input">
                    <label id="prenom" for="prenom"></label>
                ...
                <div class="field">
                    <input id="btn_inscrire" type="submit" class="btn" name="submit" value="" required>
                </div>
                <div class="links">
                <span id="message1"></span><a href="login.php"><span id="message2"></span></a>
                </div>
            </form>
        </div>
    </div>
