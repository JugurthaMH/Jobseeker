...
<body data-page="poste_dresseurPage">
    <?php
        session_start();
        include 'api.php';
    ...
    <div class="centre">
        <div class="main-container">
            ...
            <div class="box_right">
                ...
                <input type="hidden" name="poste" value="poste_dresseur"> <!-- Identifiant du poste -->
                    <div class="field">
    ...
    <!-- <div class="circular-btn-container">
        <button class="circular-btn" id="musicBtn" onclick="toggleMusic()">Play</button>
    </div>
    <audio id="music" loop>
        <source src="musique/Pokemon Noire Blanc - Meanville Jazz compressed.mp3" type="audio/mpeg">
    </audio>
    <script src="musique.js?v=<?php echo time();?>"></script> -->
    <!-- Pied de page -->
    <footer>
