...
<body data-page="poste_coiffeurPage">
    <?php
        session_start();
        include 'api.php';
    ...
    <div class="centre">
        <div class="main-container">
            ...
            <div class="box_right">
                ...
                <input type="hidden" name="poste" value="poste_coiffeur"> <!-- Identifiant du poste -->
                    <div class="field">
                        <label id="lettre" for="lettre">Lettre de Motivation :</label>
                        <textarea id="lettre" name="lettre" rows="10"></textarea>
                    </div>
                    <div class="field">
                        <label id="resume" for="cv">CV :</label>
